...
import type { CompanySlice } from './types'
...
// Re-export the slice SHAPE so existing `from './slices/company/slice'` imports
// (e.g. appStore.ts) keep resolving `CompanySlice`; its definition lives in
// ./types to keep interfaces separate from the slice DEFINITION below.
export type { CompanySlice } from './types'

// Company page slice — DEFINITION only. Its public shape lives in ./types and
